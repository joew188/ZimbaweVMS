...
/**
 * Created by Laxton-Joe on 2017/8/18.
 */
public class TestDataImport implements Runnable {
    ...
    public TestDataImport(int beginIndex) {
    ...
    public void run() {
        ...
        for (int i = 1; i < 5; i++) {
            Tester ter = new Tester(sample, i, 4000, beginIndex);
