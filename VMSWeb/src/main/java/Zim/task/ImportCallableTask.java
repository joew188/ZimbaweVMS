...
//
///**
// * Created by Laxton-Joe on 2017/8/14.
// */
//public class ImportCallableTask implements Callable<ConcurrentLinkedQueue<ImportCallableTask.ImportResult>> {
//
...
//
//
//    public ImportCallableTask(String exportFile) {
...
//     * @param recordQueue
//     */
//    private void updateTaskInfo(DBObject importLog, ConcurrentLinkedQueue<ImportCallableTask.ImportResult> recordQueue) {
//        int total = 0;
//        int male = 0;
//        int female = 0;
//        for (ImportCallableTask.ImportResult iResult : recordQueue) {
...
//
//    @Override
//    public ConcurrentLinkedQueue<ImportCallableTask.ImportResult> call() throws Exception {
//        ConcurrentLinkedQueue<String> fileQueue = new ConcurrentLinkedQueue<String>();
//        ConcurrentLinkedQueue<ImportCallableTask.ImportResult> recordQueue = new ConcurrentLinkedQueue<>();
//        File directory = new File(this.xmlFilePath);
//        if (directory.isDirectory()) {
//            ImportCallableTask.GenericExtFilter filter = new ImportCallableTask.GenericExtFilter(".xml");
...
//
//                ImportCallableTask.Producer producer = new ImportCallableTask.Producer(fileQueue, buffer, this.xmlFilePath);
//                ImportCallableTask.Consumer consumer = new ImportCallableTask.Consumer(count, buffer, recordQueue, matcherQueue, flag);
//                ImportCallableTask.Matcher matcher = new ImportCallableTask.Matcher(count2, matcherQueue);
...
//        private ConcurrentLinkedQueue<ImportCallableTask.ImportResult> recordQueue;
//        private ConcurrentLinkedQueue<MatchInfo> matcherQueue;
//        private String[] flag;
//
//        public Consumer(AtomicInteger count,
//                        BlockingQueue<Applicant> buffer,
//                        ConcurrentLinkedQueue<ImportCallableTask.ImportResult> recordQueue,
...
//                ImportCallableTask.ImportResult iResult = new ImportCallableTask.ImportResult();
