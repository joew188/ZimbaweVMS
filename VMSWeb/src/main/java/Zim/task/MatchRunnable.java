...
//            while (true) {
//                try {
//                    if (mongoDBDaoImpl.IsQueue()) {
//                        DBObject dbObj = mongoDBDaoImpl.getQueue();
//                        String mqId = dbObj.get(MatchQueue.ID).toString();
//                        int birthDay = (int) dbObj.get(MatchQueue.DATEOFBIRTH);
//                        String name = dbObj.get(MatchQueue.SURNAME).toString();
//                        int gender = Integer.parseInt(dbObj.get(MatchQueue.GENDER).toString());
